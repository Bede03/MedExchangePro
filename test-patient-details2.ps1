...
# Test getting patient by national ID (KFH patient)
$response = Invoke-WebRequest -Uri "http://localhost:5000/api/patients/1198805121234567/combined" -UseBasicParsing -Headers @{"Authorization"="Bearer $token"}
$response.Content